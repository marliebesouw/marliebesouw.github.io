...
<div class="program">
  ...
  <div class="program-item">
    ...
    <div class="program-text"><strong>Registration &amp; welcome coffee/tea</strong></div>
  </div>
  ...
  <!-- Morning parallel: Workshop OR Insight -->
  <div class="program-item">
    <div class="program-time">11:00–12:30</div>
    <div class="program-text">
      <strong>Groups A1 + A2:</strong> <em>Hands-on workshop: selecting an AI system</em> — Speaker: <a href="{{ site.url }}/speakers#kicky-van-leeuwen" class="speaker-link">Kicky van Leeuwen</a><br>
      <strong>Group B1 + B2 (parallel):</strong> <em>Insight session: AI in clinical practice</em> (Cardiology, Pathology, Radiology, Radiotherapy)
    </div>
    <div class="speaker-thumb-grid">
      <a href="{{ site.url }}/speakers#kicky-van-leeuwen">
        <img src="{{ site.url }}/assets/img/Kicky_van_Leeuwen.jpg" class="speaker-thumb" alt="Kicky van Leeuwen">
  ...
  <!-- Insight speakers list (kept as-is) -->
  <div class="program-item">
  ...
  <div class="program-item">
    ...
    <div class="program-text"><strong>Lunch &amp; networking</strong></div>
  </div>

  <!-- Afternoon parallel: Insight OR Workshop -->
  <div class="program-item">
    <div class="program-time">13:30–15:00</div>
    <div class="program-text">
      <strong>Groups A1 + A2:</strong> <em>Insight session (parallel): AI in clinical practice</em> (Cardiology, Pathology, Radiology, Radiotherapy)<br>
      <strong>Group B1 + B2:</strong> <em>Hands-on workshop: selecting an AI system</em> — Speaker: <a href="{{ site.url }}/speakers#kicky-van-leeuwen" class="speaker-link">Kicky van Leeuwen</a>
    </div>
    <div class="speaker-thumb-grid">
      <a href="{{ site.url }}/speakers#kicky-van-leeuwen">
        <img src="{{ site.url }}/assets/img/Kicky_van_Leeuwen.jpg" class="speaker-thumb" alt="Kicky van Leeuwen">
